# Repository Setup To Do Items

1. Determine 'ownership' of the repository
2. Define initial structure of repository and folders
   - Folders per function?  "Partner Onboarding", "Good Practice Reports", etc.
   - ...per type (FlexReport, Policy, etc.)?
   - Tagging?
